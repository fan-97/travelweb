...
<div class="wrap">
    <div class="bread_box">
        <a href="/">首页</a>
        <span> &gt;</span>
        <a href="#">${scenery.c_Name}</a><span> &gt;</span>
    </div>
    <div class="prosum_box">
        <dl class="prosum_left">
            <dt>
                <img alt="" class="big_img" src="img/product/size2/m2a0b210f47a778170efe260bd75a2fd01.jpg">
            </dt>
            <dd>
                <a class="up_img up_img_disable"></a>
                    <a title="" class="little_img" data-bigpic="img/product/size2/m2a0b210f47a778170efe260bd75a2fd01.jpg">
                        <img src="img/product/small/m3a1c3be962560ab5e4bc39146f4749973.jpg">
                    </a>
                    <a title="" class="little_img" data-bigpic="img/product/size2/m2a0b210f47a778170efe260bd75a2fd01.jpg">
                        <img src="img/product/small/m3a02b93b97f0764d6a3ac4fc75a30b495.jpg">
                    </a>
                    <a title="" class="little_img" data-bigpic="img/product/size2/m2a0b210f47a778170efe260bd75a2fd01.jpg">
                        <img src="img/product/small/m3a0b210f47a778170efe260bd75a2fd01.jpg">
                    </a>
                    <a title="" class="little_img" data-bigpic="img/product/size2/m2a0b210f47a778170efe260bd75a2fd01.jpg">
                        <img src="img/product/small/m3a92bdb8a11c5f83bdeddb8ee3abbd3fc.jpg">
                    </a>
                    <a title="" class="little_img" data-bigpic="img/product/size2/m2a0b210f47a778170efe260bd75a2fd01.jpg">
                        <img src="img/product/small/m3b08e4d7f21ac03d7c759446017cc33c4.jpg">
                    </a>
                <a class="down_img down_img_disable" style="margin-bottom: 0;"></a>
            </dd>
        </dl>
        <div class="prosum_right">
            <p class="pros_title">${scenery.c_Name}</p>
            <p class="hot">${scenery.c_Introduction}</p>
            <div class="pros_other">
                <p>景点级别  ：${scenery.c_Level}</p>
                <p>景点类型 : ${scenery.c_Type}</p>
                <p>适宜人群 ： ${scenery.c_Fit}</p>
            </div>
            <div class="pros_price">
                <p class="price"><strong>¥${scenery.c_Price}</strong><span>起</span></p>
                <p class="collect">
