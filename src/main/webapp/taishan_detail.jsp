...
<div class="wrap">
    ...
    <div class="prosum_box">
        <dl class="prosum_left">
            <dt>
                <img alt="" class="big_img" src="img/product/size2/taishan-1.jpg">
            </dt>
            <dd>
                <a class="up_img up_img_disable"></a>
                    <a title="" class="little_img" data-bigpic="img/product/size2/taishan-1.jpg">
                        <img src="img/product/small/taishan-2.jpg">
                    </a>
                    <a title="" class="little_img" data-bigpic="img/product/size2/tai2-1.jpg">
                        <img src="img/product/small/tai2-2.jpg">
                    </a>
                    <a title="" class="little_img" data-bigpic="img/product/size2/m2a0b210f47a778170efe260bd75a2fd01.jpg">
                        <img src="img/product/small/m3a0b210f47a778170efe260bd75a2fd01.jpg">
                    </a>
                    <a title="" class="little_img" data-bigpic="img/product/size2/tai5(1).jpg">
                        <img src="img/product/small/tai5(2).jpg">
                    </a>
                    <a title="" class="little_img" data-bigpic="img/product/size2/tai4(1).jpg">
                        <img src="img/product/small/tai4(2).jpg">
                    </a>
                <a class="down_img down_img_disable" style="margin-bottom: 0;"></a>
            </dd>
        </dl>
        <div class="prosum_right">
            <p class="pros_title"> 泰山 </p>
            <p class="hot">青岛高铁直达泰山2天1晚自由行(春节预售+亲子/蜜月/休闲游首选+豪华酒店任选+接送站）</p>
            <div class="pros_other">
                <p>景点级别  ：AAAAA </p>
                <p>景点类型 :  自然景观 </p>
                <p>适宜人群 ： 年轻人 老年人（体格健壮） </p>
            </div>
            <div class="pros_price">
                <p class="price"><strong>¥2000</strong><span>起</span></p>
                <p class="collect">
